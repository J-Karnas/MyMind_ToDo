...
<body class="page notes">
    ...
    <div class="notes__container">
        ...
        <div class="notes__note note frame">
            <p class="notes__note-title">Shopping1</p>
        ...
        <div class="notes__note note frame">
            <p class="notes__note-title">Shopping2</p>
            <p class="notes__note-description">
        ...
        <div class="notes__note note frame">
            <p class="notes__note-title">Shopping3</p>
            <p class="notes__note-description">
        ...
        <div class="notes__note note frame">
            <p class="notes__note-title">Shopping4</p>
            <p class="notes__note-description">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
            </p>
        </div>
        ...
        <div class="notes__note note frame">
            <p class="notes__note-title">Shopping5</p>
            <p class="notes__note-description">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
        </div>
